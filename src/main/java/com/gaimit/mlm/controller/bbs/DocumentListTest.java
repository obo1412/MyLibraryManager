...
public class DocumentListTest {
	...
	private static Logger logger = LoggerFactory.getLogger(DocumentListTest.class);
	@Autowired
	...
	@RequestMapping(value = "/bbs/document_list_test.do"/*, method = {RequestMethod.GET, RequestMethod.POST}*/)
	public ModelAndView doRun(Locale locale, Model model, HttpServletRequest request, HttpServletResponse response) {
		...
		String view = "bbs/document_list_test";
