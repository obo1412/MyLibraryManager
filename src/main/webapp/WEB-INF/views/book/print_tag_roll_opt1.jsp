...
<body>
	<div class="prtNone">
		<span class="prtNone" style="font-size:30pt;">롤프린터 태그 - 옵션1</span>
		<span class="prtNone">
				...
				<div class="tagSection" style="padding-top:${tag.titleTagGap}mm; width:100%; height:30mm;">
					...
					<div class="tagRightSection" style="width:50%; height:100%; float:right;">
						...
						<div class="kdc1Section" style="float:left; width:16mm; height:100%; background-color:${item.classCodeColor};">
							<div style="color:white; text-align:center; position:relative; top:50%; transform:translate(0,-50%);">
								<div style="font-size: 35pt; font-weight:900; transform:rotate(90deg);">
									${item.classCodeHead}
								</div>
							</div>
						</div>
						<div class="callNoBox" style="float:right; width:33mm; height:100%;">
							<div class="callText" style="float:left; width:19mm; height:100%; font-size:3mm; line-height:3mm; transform:rotate(90deg);">
								<div style="transform:translate(4mm,4mm); font-weight:bold;">
							...
							<div class="callNo" style="background-color:${item.classCodeColor}; float:right; width:10mm; height:100%;">
								<div style="position:relative; top:50%; transform:translate(-1mm,-50%);">
									<div style="font-size:4mm; font-weight:900; color:white;">
										<div style="transform:rotate(90deg);">
											<div style="white-space:nowrap;">
												<c:choose>
													<c:when test="${item.classCodeHead ge 3 and item.classCodeHead lt 6}">
														<div style="text-indent:-30%;">
															${item.classCodeSection}
														</div>
													</c:when>
													<c:otherwise>
														${item.classCodeSection}
