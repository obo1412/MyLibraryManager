	...
	<div id='wrapper'>
		...
		<div id="content-wrapper">
			...
			<div class="container-fluid" style="margin-left:-1.25mm; margin-top:-1.9mm;">
				...
				<div class="prtNone">${fn:length(bookHeldList)}</div>
				...
				<c:forEach var="item" items="${bookHeldList}" varStatus="status">
					...
					<div style="/* border:1px dashed red; */ width: 125mm; float: left;">
						<div id="titleRmk"
						...
						<div id="wholeBox"
							...
							<div id="leftBox"
								style="/* border:1px solid black; */ padding-left:4mm; text-align: center; float: left; width: 56mm; height: 100%;">
								<div
