											...
											<tr>
												<c:choose>
													<c:when test="${item.dueDateBrw < currentDate}">
														...
														<c:set var="classBtn" value="btn btn-danger btn-sm text-white" />
													</c:when>
													<c:otherwise>
														<c:set var="state" value="예정" />
														<c:set var="classBtn" value="btn btn-warning btn-sm text-white" />
													</c:otherwise>
												</c:choose>
												<td class="text-center ${classBtn}">${state}</td>
