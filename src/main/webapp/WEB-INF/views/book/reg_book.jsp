			...
			<div class="container-fluid">
				...
				<form class="form-horizontal info-section" name="myform"
					...
					<div class="form-inline mgbox">
						...
						<div class="form-group">
							<label for='buyDonate'
								class="col-md-4 col-md-offset-1 control-label">구입/기증</label>
							<div class="col-md-4">
					...
					<div class="form-inline mgbox">
						<div class="form-group">
							<label for='isbn13' class="col-md-4 control-label">ISBN
								13</label>
							<div class="col-md-5">
						...
						<div class="form-group">
							<label for='isbn10'
								class="col-md-4 col-md-offset-1 control-label">ISBN 10</label>
							<div class="col-md-5">
					...
					<div class="form-inline mgbox">
						<div class="form-group">
							<label for='bookCateg' class="col-md-4 control-label">도서
								분류</label>
							<div class="col-md-5">
								<input type="text" name="bookCateg" id="bookCateg"
									class="form-control" value="${jsonAladin.item[0].categoryName}" />
							</div>
						</div>

						<div class="form-group">
							<label for='categCode'
								class="col-md-4 col-md-offset-1 control-label">분류 기호</label>
							<div class="col-md-5">
					...
					<div class="form-inline mgbox">
						...
						<div class="form-group">
							<label for='authorCode'
								class="col-md-4 col-md-offset-1 control-label">저자 기호</label>
							<div class="col-md-5">
					...
					<div class="form-inline mgbox">
						...
						<div class="form-group">
							<label for='pubDate'
								class="col-md-4 col-md-offset-1 control-label">출판일</label>
							<div class="col-md-5">
					...
					<div class='form-horizontal mgbox'>
						...
						<div class="form-inline">
							...
							<textarea
								class="txt-box form-control custom-control col-md-7 col-md-offset-1"
								name='bookDesc' id="bookDesc"
								style="resize: none; height: 130px; width: 60%;">${jsonAladin.item[0].description}
				</textarea>
						</div>
					</div>
