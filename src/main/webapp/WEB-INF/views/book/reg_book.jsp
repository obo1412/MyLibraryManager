...
$(function() {
	$("#searchEx").click(function(e) {
		e.preventDefault();
		$("#search-book-info").val("9788936433673");
	...
	$("#btn-search-bookinfo").click(function(e) {
		...
		$.post("http://www.aladin.co.kr/ttb/api/ItemLookUp.aspx?ttbkey=ttbanfyanfy991303001&itemIdType=ISBN13&output=js&Version=20131101"
				+"&ItemId="+bKeyword,
			 function(json) {
