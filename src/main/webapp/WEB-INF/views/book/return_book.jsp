...
<div class='container con-left'>
    ...
    <form class="form-horizontal" name="search-mbr-form" id="search-mbr-form" method="post"
    	...
    	<div class="form-group">
	        ...
	        <div class="input-group col-md-5">
	            <input type="text" name="bookCode" id="bookCode"
	            	class="form-control" placeholder="책코드를 입력해주세요" value="${bookCode}"/>
	            <span class="input-group-btn">
	            	<button class="btn btn-warning" id="btn-search-mbr" type="submit">
    ...
    <form class="form-horizontal" name="myform" method="post"  enctype="multipart/form-data"
        ...
        <div class="form-group">
            ...
            <div class="col-md-5">
                <input type="text" name="name" id="name" class="form-control" value="${brwItem.name}"/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-5">
                <input type="tel" name="idCode" id="idCode" class="form-control" value="${brwItem.idCode}"/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-5">
                <input type="tel" name="phone" id="phone" class="form-control" value="${brwItem.phone}"/>
            </div>
        </div>
		    		...
		    		<c:when test="${fn:length(brwList) > 0}">
		    			<c:forEach var="item" items="${brwList}" varStatus="status">
		    				<tr>
					            ...
					            <td>
					            	<c:url var="readUrl" value="/temp/temp.do">
					            		<c:param name="id" value="${item.idCodeBook}" />
					            	</c:url>
					            	<a href="${readUrl}">${item.idCodeBook}</a>
					            </td>
					            <td class="text-center">${item.nameBook}</td>
					            <td class="text-center">
					            	<a href="#">${item.startDateBrw}</a>
					            </td>
